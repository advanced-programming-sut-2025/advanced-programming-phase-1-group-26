...
public enum FarmBuilding
{
    BARN("Barn", "Houses 4 barn-dwelling animals.", 6000, mapOf(
            ...
            ResourceItem.STONE, 150), "7x4", 4, 1),
    ...
    FarmBuilding(String name, String description, int price, Map<ResourceItem, Integer> materials, String size, int capacity, int dailyLimit) {
        this.name = name;
